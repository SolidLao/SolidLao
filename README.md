...
- Efficiency
  ...
  - [SQLBarber](https://arxiv.org/abs/2507.06192) for SQL workload generation (SIGMOD Demo 2025, SIGMOD 2026)
  - [QUITE](https://arxiv.org/abs/2506.07675) for query rewrite (Under revision of SIGMOD 2026)
- Generality
  - [SemBench](http://sembench.org/), a benchmark for semantic query processing engines (Under revision of VLDB 2026)
- Usability
