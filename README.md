...
- Efficiency
  - [GenDB](https://github.com/SolidLao/GenDB), an LLM-Powered Generative Query Engine Built for the Future
...
- Generality
  - [SemBench](http://sembench.org/), a benchmark for semantic query processing engines (Conditional Accept to VLDB 2026)
- Usability
